...
public class RabbitMQConfig {
    ...
    public static final String AVANTURE_TIMESLOT_FEEDBACK_QUEUE = "avanture.timeslot.feedback.queue";
    ...
    @Bean
    public Binding timeSlotUpdatedBinding(Queue timeSlotUpdatedQueue, TopicExchange avantureExchange) {
        return BindingBuilder.bind(timeSlotUpdatedQueue)
                .to(avantureExchange)
                .with(TIMESLOT_UPDATED_ROUTING_KEY);
    }
    ...
    @Bean
    public Queue timeSlotFeedbackQueue() {
        return QueueBuilder.durable(AVANTURE_TIMESLOT_FEEDBACK_QUEUE).build();
    }
    ...
    @Bean
    public Binding timeSlotFeedbackBinding(Queue timeSlotFeedbackQueue, TopicExchange timeSlotFeedbackExchange) {
        return BindingBuilder.bind(timeSlotFeedbackQueue)
                .to(timeSlotFeedbackExchange)
                .with(TIMESLOT_FEEDBACK_ROUTING_KEY);
    }
